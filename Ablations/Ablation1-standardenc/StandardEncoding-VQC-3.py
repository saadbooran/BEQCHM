...
CONDITION_NAME = "Ablation_Standard_Encoding_VQC_3"
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"ABLATION (Standard Encoding) Condition 3: 3 Quantum Circuits, standard angle encoding (12 time points) + GRU (128 time points, 80 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_standard_encoding_vqc3_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_standard_encoding_vqc3_metrics.csv")
    ...
    print("- ABLATION (Standard Encoding) Condition 3: 3 Quantum Circuits + GRU")
    print("- Quantum Circuit 1: 4 time points (1-4) with STANDARD (non-Bessel) angle encoding")
    print("- Quantum Circuit 2: 4 time points (5-8) with STANDARD (non-Bessel) angle encoding")
    print("- Quantum Circuit 3: 4 time points (9-12) with STANDARD (non-Bessel) angle encoding")
