...
CONDITION_NAME = "Ablation_Topology_LinearOnly_VQC_2"  
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_topology_linearonly_vqc2_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_topology_linearonly_vqc2_metrics.csv")
