...
CONDITION_NAME = "Ablation_Topology_Circular_Only_VQC_1"
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"ABLATION (CIRCULAR-ONLY topology): 1 Quantum Circuit (4 time points) + GRU (136 time points, 112 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_topology_circular_only_vqc1_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_topology_circular_only_vqc1_metrics.csv")
    ...
    print("- ABLATION (CIRCULAR-ONLY topology): 1 Quantum Circuit + GRU")
