...
CONDITION_NAME = "Ablation_Topology_CircularOnly_VQC_2"  
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"CONDITION 2: 2 Quantum Circuits (8 time points) + GRU (132 time points, 96 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_topology_circularonly_vqc2_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_topology_circularonly_vqc2_metrics.csv")
    ...
    print("- CONDITION 2: 2 Quantum Circuits + GRU")
