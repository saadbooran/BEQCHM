...
CONDITION_NAME = "Ablation_Topology_StarOnly_VQC_3"  
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_topology_staronly_vqc3_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_topology_staronly_vqc3_metrics.csv")
