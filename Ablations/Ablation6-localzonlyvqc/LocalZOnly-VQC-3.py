...
CONDITION_NAME = "Ablation_Local_Z_Only_VQC_3"  
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"ABLATION (Local-Z-Only Measurement) Condition 3: 3 Quantum Circuit(s) (12 time points) + GRU (128 time points, 80 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_local_z_only_vqc3_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_local_z_only_vqc3_metrics.csv")
    ...
    print("- ABLATION (Local-Z-Only Measurement) Condition 3: 3 Quantum Circuit(s) + GRU")
