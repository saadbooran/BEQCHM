...
CONDITION_NAME = "Ablation_No_Entanglement_VQC_1"  
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"ABLATION (No Entanglement) Condition 1: 1 Quantum Circuit(s), NO entanglement (4 time points) + GRU (136 time points, 112 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_no_entanglement_vqc1_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_no_entanglement_vqc1_metrics.csv")
    ...
    print("- ABLATION (No Entanglement) Condition 1: 1 Quantum Circuit(s), NO entanglement + GRU")
    print("- Quantum: 4 time points with Bessel encoding")
