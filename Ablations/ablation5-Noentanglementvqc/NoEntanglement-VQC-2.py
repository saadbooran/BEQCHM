...
CONDITION_NAME = "Ablation_No_Entanglement_VQC_2"  
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"ABLATION (No Entanglement) Condition 2: 2 Quantum Circuit(s), NO entanglement (8 time points) + GRU (132 time points, 96 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "ablation_no_entanglement_vqc2_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_ablation_no_entanglement_vqc2_metrics.csv")
    ...
    print("- ABLATION (No Entanglement) Condition 2: 2 Quantum Circuit(s), NO entanglement + GRU")
