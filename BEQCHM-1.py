...
CONDITION_NAME = "Condition_1_Quantum_1_Circuit"  
...
def run_roi_file(file_path, roi_number, n_splits=3):
    ...
    print(f"CONDITION 1: 1 Quantum Circuit (4 time points) + GRU (136 time points, 112 hidden)")
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "condition_1_quantum_1_circuit_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_condition_1_metrics.csv")
    ...
    print("- CONDITION 1: 1 Quantum Circuit + GRU")
