...
CONDITION_NAME = "Condition_2_Quantum_2_Circuits"  
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "condition_2_quantum_2_circuits_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_condition_2_metrics.csv")
