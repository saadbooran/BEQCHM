...
CONDITION_NAME = "Condition_3_Quantum_3_Circuits"  
...
if __name__ == "__main__":
    ...
    try:
        ...
        results_path = os.path.join(CONDITION_FOLDER, "condition_3_quantum_3_circuits_results.csv")
    ...
    try:
        if all_detailed_metrics:
            ...
            detailed_path = os.path.join(CONDITION_FOLDER, "detailed_condition_3_metrics.csv")
